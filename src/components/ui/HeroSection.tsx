...
export default function HeroSection() {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-black flex items-center justify-center">
      ...
      {theme === 'light' && (
        <div className="absolute inset-0 z-0 bg-black">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center z-10 pointer-events-none">
            <span className="font-cinzel jp-text text-6xl md:text-8xl glow-blue slash-reveal-blue mb-4 tracking-[0.2em] font-black drop-shadow-[0_0_15px_rgba(185,226,255,0.8)]" style={{ color: "#b9e2ff" }}>無量空処</span>
            <span className="font-cinzel en-text text-xl md:text-3xl glow-blue slash-reveal-blue tracking-[0.4em] uppercase font-bold drop-shadow-[0_0_10px_rgba(185,226,255,0.6)]" style={{ color: "#b9e2ff" }}>Infinite Void</span>
          </div>
        </div>
      )}
      ...
      {/* ── Call To Action overlay (Displays in both modes) ── */}
      <motion.div
